            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" value="{{old('description',$book->description)}}" id="description" class="form-control @error('description') is-invalid 
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        @if (!empty($book->image))
                            <img class="w-25 my-2" src="{{asset('uploads/books/thumb/'.$book->image)}}" alt="book-thumbnail">
                        @endif
                    </div>
